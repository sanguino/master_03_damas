...
public class CoordinateTestDG {
    ...
    public void testDirections() {
        ...
        List<CoordinatesDirectionDG> coordinatesDirections = Arrays.asList(
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(6, 6), Direction.NE),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(6, 4), Direction.NW),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(4, 6), Direction.SE),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(4, 4), Direction.SW),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(5, 6), null),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(6, 5), null),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(5, 4), null),
                new CoordinatesDirectionDG(new Coordinate(5, 5), new Coordinate(4, 5), null));

        for (CoordinatesDirectionDG coordinatesDirection : coordinatesDirections) {
    ...
    public void testIsOnDiagonal() {
        ...
        List<CoordinatesDG> coordinatesIsOnDiagonal = Arrays.asList(
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(6, 6)),
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(6, 4)),
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(4, 6)),
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(4, 4)));

        List<CoordinatesDG> coordinatesIsNotOnDiagonal = Arrays.asList(
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(5, 6)),
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(6, 5)),
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(5, 4)),
                new CoordinatesDG(new Coordinate(5, 5), new Coordinate(4, 5)));

        for (CoordinatesDG coordinate : coordinatesIsOnDiagonal) {
            assertTrue(coordinate.getOriginCoordinate().isOnDiagonal(coordinate.getTargetCoordinate()));
        }

        for (CoordinatesDG coordinate : coordinatesIsNotOnDiagonal) {
